...
function initMap(){
    ...
    var terrainLayer = new Cesium.CesiumTerrainProvider({
        url: "http://211.154.194.45:8080/tms/1.0.0/gujiaodem_terrain@EPSG:4326@terrain",
        // 请求照明
    ...
    viewer.homeButton.viewModel.command.beforeExecute.addEventListener(function(e) {
        ...
        //你要飞的位置
        viewer.camera.flyTo({
            destination: Cesium.Cartesian3.fromDegrees(112.4053272,37.9951311,3489)
        });
    });
    ...
    viewer.camera.changed.addEventListener(function (percentage) {
        ...
        $("#i_extent").text("边界["+str.join(",")+"],高程:"+ext.height.toFixed(0));
    });
    //获取鼠标单击处的经度、纬度、高程
...
CesiumEventHandler.setInputAction(function (movement) {
    ...
    viewer.scene.camera.setView({
        // 初始化相机经纬度
        destination : new Cesium.Cartesian3.fromDegrees(112.4053272,37.9951311,3489)
    });
